...
fig, ax = plt.subplots()
with open('push_front_forwlist.txt', 'r') as reading:
...
fig, ax = plt.subplots()
with open('push_front_subforwlist.txt', 'r') as reading:
    file_input = reading.read().split('\n')
...
plt.ylabel('time of pushing, mcs', fontsize = 15)
...
plt.title('Push_forward', fontsize = 20)
